...
def main(args):
    ...
    train_dataset = DataLoader(root='data', args=args, split='train', process_data=True)
    test_dataset = DataLoader(root='data', args=args, split='test', process_data=True)
    ...
    classifier = get_model(num_class, normal_channel=args.use_normals).cuda()
    ...
    try:
        ...
        log_string('Use pre train model')
    except:
